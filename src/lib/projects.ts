export interface Project {
  ...
  images: string[]
  gridLayout: 'bombay' | 'perfume' | 'tableware' | 'luccica' | 'raices' | 'aura' | 'coleccion' | 'diamantes'
}
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    images: [
      ...
      '/projects/product/tableware/5.jpg',
      '/projects/product/tableware/6.jpg',
    ],
  ...
  },
  {
    ...
    images: [
      ...
      '/projects/fashion/raices/8.jpg',
      '/projects/fashion/raices/9.jpg',
    ],
    gridLayout: 'raices',
  },
  {
  ...
  },
  {
    ...
    images: [
      ...
      '/projects/graphic/diamantes/5.jpg',
      '/projects/graphic/diamantes/6.jpg',
    ],
...
export function getProject(category: string, slug: string): Project | undefined {
...
export function getNextProject(currentProject: Project): Project | undefined {
  ...
  const currentIndex = categoryProjects.findIndex(p => p.slug === currentProject.slug)
  return categoryProjects[currentIndex + 1] || categoryProjects[0]
}

export function getPreviousProject(currentProject: Project): Project | undefined {
  const categoryProjects = projects.filter(p => p.category === currentProject.category)
  const currentIndex = categoryProjects.findIndex(p => p.slug === currentProject.slug)
  return categoryProjects[currentIndex - 1] || categoryProjects[categoryProjects.length - 1]
}
